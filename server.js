...
var dbRoutes = require('./routes/artist.js'); 
...
//app.get('/artists', artistRoutes.getArtists);
app.get('/artist/:firstname/:lastname', dbRoutes.getArtist);
app.post('/artist/:firstname/:lastname', dbRoutes.postArtist);
app.put('/artist/:firstname/:lastname/:band/:genre', dbRoutes.putArtist);
app.delete('/artist/:firstname/:lastname', dbRoutes.deleteArtist);
